  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#0d0a16] text-white">
      <section className="mx-auto min-h-screen max-w-[1440px] px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid gap-5 lg:grid-cols-[1fr_420px]"><div className="rounded-[1.75rem] border bg-white/9 border-white/12 p-6"><div className="grid size-20 place-items-center rounded-full text-xl font-black text-black" style={{ backgroundColor: "#f0abfc" }}>APF</div><h1 className="mt-6 text-5xl font-black sm:text-7xl">AI Personal Finance Agent</h1><p className="mt-5 max-w-3xl leading-8 text-white/62">A personal finance planning agent starter with budgeting guardrails and runway analysis.</p></div><div className="grid gap-3">{steps.map((step) => <div className="rounded-[1.75rem] border bg-white/9 border-white/12 p-4" key={step}><p className="font-black">{step}</p></div>)}</div></div>
